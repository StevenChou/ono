        ...
        >
          ...
          >
            <div className='border-bottom px-3 pt-3 pb-3 d-flex justify-content-between align-items-end'>
              <span className='h4 mb-0'>通知</span>
            ...
            <Dropdown.Item className='mt-3'>
              <div className='d-flex'>
                ...
                <div className='ms-3 lh-1'>
                  <h5 className='mb-1'>Whalebro</h5>
                  <p className='mb-0 text-muted'>whalebro@gmail.com</p>
                </div>
              </div>
            </Dropdown.Item>
            <Dropdown.Divider />
            <Dropdown.Item eventKey='2'>
              <i className='fe fe-user me-2'></i> 基本資料
            </Dropdown.Item>
            <Dropdown.Item eventKey='3'>
              <i className='fe fe-star me-2'></i> 訂閱
            </Dropdown.Item>
            <Dropdown.Item>
